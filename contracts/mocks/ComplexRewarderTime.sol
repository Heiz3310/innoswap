...
contract ComplexRewarderTime is IRewarder,  BoringOwnable{
    ...
    constructor (IERC20 _rewardToken, uint256 _rewardPerSecond, address _MASTERDEVELOPER_V2) public {
    ...
    /// @param _rewardPerSecond The amount of Innovai to be distributed per second.
    ...
    function pendingToken(uint256 _pid, address _user) public view returns (uint256 pending) {
        ...
        if (block.timestamp > pool.lastRewardTime && lpSupply != 0) {
            ...
            uint256 innovaiReward = time.mul(rewardPerSecond).mul(pool.allocPoint) / totalAllocPoint;
