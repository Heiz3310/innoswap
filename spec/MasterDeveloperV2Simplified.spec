 ...
 *
 * Run this file with scripts/_runMasterDeveloperV2Simplified.sh
 */
...
methods {
	...
	// overrided methods
	innovaiPerBlock() returns (uint256 amount)
	...
	// INNAI token
	INNAI() returns (address) envfree // NOT USED
	innovaiToken.balanceOf(address) returns (uint256) // NOT USED
	...
	// Rewarder
	// SIG_ON_INNAI_REWARD = 0xbb6cc2ef; // onInnovaiReward(uint256,address,uint256)
	0xbb6cc2ef => NONDET
