...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  const innoswapRouterAddress = (await deployments.get("UniswapV2Router02")).address

  await deploy("InnoSwapMigrator", {
    from: deployer,
    args: [uniswapRouterAddress, innoswapRouterAddress],
    log: true,
    deterministicDeployment: false
  })
}

module.exports.tags = ["InnoSwapMigrator"]
